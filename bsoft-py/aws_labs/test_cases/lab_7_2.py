...
def test_stack_exists(name, check_status=True):
...
def run_test_cases(credentials):
    ...
    print("=" * 65)
    print("LAB 7_2 VALIDATION: CloudFormation Infrastructure as Code")
    print("=" * 65)
    print("\n── VPC Stack ──")
    ...
    print("\n── EC2 Stack ──")
    ec2_stack = test_stack_exists(EC2_STACK_NAME, check_status=False)
